...
def train_model(strideLen, kernelLen, gaussianSmoothWidth):
    strideLen = int(strideLen)
    kernelLen = int(kernelLen)
    gaussianSmoothWidth = gaussianSmoothWidth
    
    exp_name = f'gru_{strideLen}_{kernelLen}_{gaussianSmoothWidth}'
    ...
    model = GRUEncoder(strideLen=strideLen, kernelLen=kernelLen, gaussianSmoothWidth=gaussianSmoothWidth)
