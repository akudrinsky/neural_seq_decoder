...
model = T5ForConditionalGeneration.from_pretrained('./results/checkpoint-204000/')
...
def phonemes_to_sentence(phonemes):
    ...
    with torch.no_grad():
        outputs = model.generate(
            ...
            num_beams=5,
            early_stopping=True,
            length_penalty=100.0,  # You can adjust this to penalize longer sequences
...
# Example usage
phoneme_list = ['B', 'IH', 'G', ' ', 'AE', 'P', 'L', ' ', 'CH', 'EH', 'K', '<PAD>']
